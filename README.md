 ...
 *
 * @constructor
 * @param {string} Ubicación - España, Sevilla
 * @param {string} Idiomas - Español, Inglés, Francés
 * @param {string} Ocupación - Estudiante de Desarrollo de Aplicaciones Multiplataforma
 * @param {string} Formación - Bachillerato 
 * @param {string} Habilidades- Resolutiva, pensamiento crítico, liderazgo
 *
...
<div>
  <p style="display: inline-block;" align="center">
    <kbd>
      <kbd>Lenguajes de Progrmación</kbd>
      <br>
      <br>
      <img width="30px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" alt="js" title="Java"/> 
    ...
    <kbd>
      <kbd>Basse de Datos</kbd>
      <br>
      <br>
      <img width="30px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-plain.svg" alt="mysql" title="SQL"/>
      <img width="30px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg" alt="postgres" title="DDL"/>
...
------
Credit: [Alba Durán Bernal ](https://github.com/albaduranbernal)

Modificado por ultima vez: 13/03/2026
